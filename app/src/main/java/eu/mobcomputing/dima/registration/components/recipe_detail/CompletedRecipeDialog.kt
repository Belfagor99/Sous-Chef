...
@Composable
fun CompletedRecipeDialog(

    onDismissRequest: () -> Unit,
    onConfirmation: (List<Ingredient>) -> Unit,
    dialogTitle: String,
    ingredients: List<Ingredient>,
) {

    var ingredientToRemove by remember { mutableStateOf(emptyList<Ingredient>()) }
        ...
        Card(
            ...
            Column(
                        ...
                        ElevatedFilterChip(
                            ...
                            onClick = {
                                ...
                                if(it.selectedState.value){
                                    ...
                                    ingredientToRemove = ingredientToRemove.toMutableList().apply {
                                        add(it.ingredient)
                                        numberOfSelection++
                                    }
                                }else{
                                    ingredientToRemove = ingredientToRemove.toMutableList().apply {
                                        remove(it.ingredient)
                                    }
                                }
                ...
                Row(
                    ...
                    TextButton(
                        onClick = { onConfirmation(ingredientToRemove) },
                        modifier = Modifier.padding(8.dp),
                        colors = ButtonDefaults.buttonColors(colorResource(R.color.pink_900)),
                    ) {
                        Text(
